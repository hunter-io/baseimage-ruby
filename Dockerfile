...
ENV PATH=${PATH}:/usr/local/rvm/rubies/ruby-3.2.1/bin
ENV PATH=${PATH}:/usr/local/rvm/gems/ruby-3.2.1/bin
ENV GEM_HOME /usr/local/rvm/gems/ruby-3.2.1
ENV GEM_PATH /usr/local/rvm/gems/ruby-3.2.1
